% rebase('loginlayout.tpl', title=title, year=year, errormessage=errormessage, record=record)
<html>
  <head>
  ...
  <body >
    <div class="testbox">
      <form name=form1 action ="/create" method = "post">
        ...
        <div><span style="color:red">{{ errormessage }}</span><br/></div>
        <div class="item">
        ...
        <div class="question">
         ...
         <input id="bdate" type="date" name="birthday" />
        ...
        <div class="item">
          ...
          <div class="city-item">
            ...
            <input type="text" name="pc" placeholder="Postal / Zip code" required/>
